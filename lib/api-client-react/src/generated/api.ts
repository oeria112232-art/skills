...
export const signContract = async (id: string,
    signatureInput: SignatureInput, options?: RequestInit): Promise<Contract> => {
 ...
 */
export const resendContract = async (id: string, options?: RequestInit): Promise<Contract> => {
 ...
 */
export const formatContractWithAi = async (formatContractInput: FormatContractInput, options?: RequestInit): Promise<FormattedContract> => {
