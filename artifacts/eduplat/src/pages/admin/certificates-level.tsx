            ...
            <div className="lg:col-span-8">
              {selectedWorkshop ? (
                <div 
                  ...
                  style={{ 
                    backgroundImage: !!selectedWorkshop.certTemplateUrl ? `url(${selectedWorkshop.certTemplateUrl})` : undefined,
                    backgroundSize: !!selectedWorkshop.certTemplateUrl ? "cover" : undefined,
                    backgroundPosition: !!selectedWorkshop.certTemplateUrl ? "center" : undefined,
                    background: !selectedWorkshop.certTemplateUrl ? (
                ...
                >
                  ...
                  <div className="text-center max-w-lg mx-auto space-y-2 z-10">
